...
### Développeur Web Junior · Brazzaville 🇨🇬
...
const sekou = {
    ...
    objectif     : "Développeur Fullstack + Freelance",
    approche     : "Construire en public — chaque projet = un contenu",
    disponible   : true
};
```
...
![Stats GitHub](https://github-readme-stats.vercel.app/api?username=Salla-creators&show_icons=true&theme=radical&hide_border=true&bg_color=0d1117&title_color=00ff88&icon_color=00ff88)
...
✅ HTML & CSS          — Maîtrisé
✅ Git & GitHub        — Maîtrisé
✅ JavaScript DOM      — Maîtrisé
✅ Fetch API           — Maîtrisé
✅ localStorage        — Maîtrisé
🔄 PHP avancé + POO   — En cours
⏳ Laravel + MVC      — À venir
⏳ API REST            — À venir
⏳ IA + Freelancing    — À venir
```
...
- 📱 Créer du contenu tech sans montrer son visage
